...
set search path to <dbSchema>,public;
...
GRANT ALL ON FSP_INP_HEADER to <dbUser>;
GRANT ALL ON FSP_INP_TOTALS to <dbUser>;
GRANT ALL ON FSP_INP_DIVISIONS to <dbUser>;
GRANT ALL ON FSP_OUT_DATA to <dbUser>;
GRANT ALL ON FSP_OUT_DIVISIONS to <dbUser>;
